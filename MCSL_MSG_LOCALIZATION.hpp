#ifndef MCSL_MSG_LOCALIZATION_HPP
#define MCSL_MSG_LOCALIZATION_HPP

   #define __PARSE_NULL_STR_MSG "cannot parse null string"
   #define __OVERSIZED_COPY_MSG "cannot copy larger container into buffer"
